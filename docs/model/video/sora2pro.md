...
````yaml en/api-manual/video-series/sora2pro/sora2pro-video-generate.json post /v1/videos/generations
openapi: 3.1.0
info:
  title: sora-2-pro Interface
  description: >-
...
paths:
  /v1/videos/generations:
    post:
      tags:
        - Video Generation
      summary: sora-2-pro Interface
      description: >-
        - Sora 2 Pro (sora-2-pro) model supports text-to-video, image-to-video
        and other modes
            ...
            application/json:
              ...
              example:
                error:
                  ...
                  param: model
                  fallback_suggestion: sora-2-pro
        '413':
    ...
    VideoGenerationRequest:
      ...
      properties:
        ...
        duration:
          type: integer
          description: >-
            Specifies the generated video duration (seconds), default is `15`,
            representing `15 seconds`


            **Note:**

            - Currently only supports `15`, `25` values, representing `15
            seconds`, `25 seconds`

            - Billing is based on the `duration` value, higher duration costs
            more
          example: 15
        quality:
          type: string
          description: >-
            ...
            **Note:**
            ...
            - Currently, when `duration` is `15`, only `high` quality is
            supported; when `duration` is `25`, only `standard` quality is
            supported
          enum:
            - standard
            - high
