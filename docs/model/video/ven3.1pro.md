...
| --- | --- | --- | --- | --- |
| Veo 3.1 Pro | Video Generation | 720p/1080p | No | 11.520 Credits / video |
| Veo 3.1 Pro | Video Generation | 720p/1080p | Yes | 23.040 Credits / video |
| Veo 3.1 Pro | Video Generation | 4K | No | 23.040 Credits / video |
| Veo 3.1 Pro | Video Generation | 4K | Yes | 34.560 Credits / video |


## OpenAPI

````yaml en/api-manual/video-series/veo3.1/veo-3.1-generate-preview-generate.json post /v1/videos/generations
openapi: 3.1.0
info:
  title: Veo-3.1-Generate-Preview API
  description: Create video generation tasks using AI models
  license:
    name: MIT
  version: 1.0.0
servers:
...
paths:
  /v1/videos/generations:
    post:
      tags:
        - Video Generation
      summary: Veo-3.1-Generate-Preview API
      description: >-
        - Veo 3.1 Generate Preview supports text-to-video, first-frame
  ...
  schemas:
    VideoGenerationRequest:
      ...
      properties:
        ...
        prompt:
          type: string
          description: Prompt, max 2000 tokens
          maxLength: 2000
        image_urls:
          type: array
          description: Reference images, max 2, max 10MB each
          items:
            type: string
            format: uri
          maxItems: 2
