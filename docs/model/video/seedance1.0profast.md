...
````yaml en/api-manual/video-series/seedance1.0/seedance-1.0-pro-fast-video-generate.json post /v1/videos/generations
openapi: 3.1.0
info:
...
paths:
  /v1/videos/generations:
    post:
      ...
      description: >-
        - Seedance 1.0 Pro Fast (doubao-seedance-1.0-pro-fast) model supports
            ...
            application/json:
              ...
              example:
                error:
                  ...
                  param: model
                  fallback_suggestion: doubao-seedance-1.0-pro-fast
        '413':
        ...
        duration:
          ...
          description: >-
            ...
            **Note:**
            ...
            - Supports any integer value between `2` and `12` seconds
        ...
        quality:
          ...
          description: >-
            ...
            **Note:**
            ...
            - `1080p`: High definition, higher pricing, this is the default
            value
          enum:
            - 480p
            - 720p
        ...
        aspect_ratio:
          ...
          description: >-
            ...
            **Text-to-video mode:**
            ...
            - Supported values: `16:9` (landscape), `9:16` (portrait), `1:1`
            (square), `4:3`, `3:4`, `21:9` (ultra-wide)
            ...
            **Image-to-video mode (when using image_urls):**
            ...
            - Supported values: In addition to the above 6 ratios, also supports
            `keep_ratio` (keep original aspect ratio) and `adaptive` (adaptive)
          example: '16:9'
        image_urls:
          type: array
          description: >-
            ...
            **Note:**
            ...
            - Number of images supported per request: `1` image
