...
> - Kling-O1 Video Edit Fast (kling-o1-video-edit-fast) model supports fast video editing
...
## Pricing
| MODEL | MODE | **Billing Range** | PRICE (CREDITS) |
| --- | --- | --- | --- |
| Kling O1 Video Edit Fast | Video Editing (Fast) | 6s (min) - 20s (max) | 6.800 Credits / second |


## OpenAPI

````yaml en/api-manual/video-series/kling/kling-o1-video-edit-fast.json post /v1/videos/generations
openapi: 3.1.0
info:
  title: kling-o1-video-edit-fast API
  description: Create video editing tasks using AI models (fast mode)
  license:
    name: MIT
  version: 1.0.0
servers:
...
paths:
  /v1/videos/generations:
    post:
      tags:
        - Video Generation
      summary: kling-o1-video-edit-fast API
      description: >-
        - Kling-O1 Video Edit Fast (kling-o1-video-edit-fast) model supports
        fast video editing
          ...
          application/json:
            ...
            examples:
              ...
              video_edit_with_reference:
                summary: Video Edit with Reference Image (Fast)
                value:
                  model: kling-o1-video-edit-fast
                  prompt: Make the video more cinematic
                  video_urls:
            ...
            application/json:
              ...
              example:
                error:
                  ...
                  param: model
                  fallback_suggestion: kling-o1-video-edit-fast
        '429':
    ...
    VideoGenerationRequest:
      ...
      properties:
        model:
          ...
          enum:
            - kling-o1-video-edit-fast
          default: kling-o1-video-edit-fast
          example: kling-o1-video-edit-fast
        prompt:
          type: string
        ...
        video_urls:
          ...
          description: >-
            ...
            **Note:**
            ...
            - Supported video duration: `6` to `20` seconds (videos under `6`
            seconds are billed as `6` seconds, videos over `20` seconds are
