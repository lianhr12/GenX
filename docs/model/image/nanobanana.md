...
> - Nano Banana (gemini-2.5-flash-image) model supports text-to-image, image-to-image, image editing and other generation modes
...
| ----------- | ----------------------------------- | --------------------- |
| Nano Banana | Image Generation (Gemini 2.5 Flash) | 1.600 Credits / image |
...
paths:
  /v1/images/generations:
    post:
      ...
      description: >-
        - Nano Banana (gemini-2.5-flash-image) model supports text-to-image,
