# GPT Image 1.5 Image Generation Lite

> - GPT Image 1.5 (gpt-image-1.5-lite) model supports text-to-image, image-to-image, and image editing modes
...
| ------------------ | ---------------- | ----------------------- |
| GPT Image 1.5 Lite | Image Generation | 0.900 Credits / request |

## OpenAPI

````yaml en/api-manual/image-series/gpt-image-1.5/gpt-image-1.5-lite-image-generation.json post /v1/images/generations
openapi: 3.1.0
info:
  title: gpt-image-1.5-lite API
  description: >-
...
paths:
  /v1/images/generations:
    post:
      ...
      description: >-
        - GPT Image 1.5 (gpt-image-1.5-lite) model supports text-to-image,
            ...
            application/json:
              ...
              example:
                error:
                  ...
                  param: model
                  fallback_suggestion: gpt-image-1.5-lite
        "413":
