...
| ------------- | ------------ | --------- | ---------------------- |
| Nano Banana 2 | Input Image  | Reference | 0.063 Credits / image  |
| Nano Banana 2 | Output Image | 1K/2K     | 8.700 Credits / image  |
| Nano Banana 2 | Output Image | 4K        | 13.824 Credits / image |

## OpenAPI

````yaml en/api-manual/image-series/nanobanana/nanobanana-pro-image-generate.json post /v1/images/generations
openapi: 3.1.0
info:
