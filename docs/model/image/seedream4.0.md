...
| ------------ | ---------------- | --------------------- |
| Seedream 4.0 | Image Generation | 1.400 Credits / image |

## OpenAPI

````yaml en/api-manual/image-series/seedream/seedream-4.0-image-generate.json post /v1/images/generations
openapi: 3.1.0
info:
...
paths:
  /v1/images/generations:
    post:
      ...
      description: >-
        - Seedream 4.0 (doubao-seedream-4.0) model supports text-to-image,
    ...
    ImageGenerationRequest:
      ...
      properties:
        ...
        "n":
          type: integer
          description: >-
            Specifies the upper limit for the number of images to generate,
            supports any integer value between `[1,15]`


            **Note:**

            - If you need to generate multiple images, please include in the
            prompt: " `generate 2 different images` " or similar instructions


            - Reference image count + final generated image count ≤ 15


            - If: reference image count + required images in prompt > 15, and
            required images in prompt ≤ parameter n value, then final generated
            image count = 15 - reference image count

            - Single request will pre-charge based on the value of `n`, actual
        ...
        size:
          ...
          description: >-
            ...
            **Method 2 - Pixel format:**
            ...
            - Width x height, such as: `1280x720`, `1024x1024`, `4096x4096` and
        ...
        prompt_priority:
          type: string
          description: >-
            Prompt optimization strategy for setting the mode of prompt
            ...
            **Options:**
            ...
            - `fast`: Fast mode, faster generation speed, average quality
          enum:
            - standard
            - fast
          default: standard
