...
| ---------------------- | ------------- | --------------------- |
| WAN 2.5 Image to Image | Image Editing | 1.500 Credits / image |

## OpenAPI

````yaml en/api-manual/image-series/wan2.5/wan2.5-text-to-image.json post /v1/images/generations
openapi: 3.1.0
info:
  title: wan2.5-text-to-image Interface
  description: >-
    Use WAN2.5 model for text-to-image generation with simplified model
...
paths:
  /v1/images/generations:
    post:
      ...
      description: >-
        - WAN2.5 (wan2.5-text-to-image) model supports text-to-image generation
        mode
  ...
  schemas:
    Wan25TextToImageRequest:
      ...
      properties:
        ...
        prompt:
          type: string
          description: Prompt describing the image to generate, limited to 2000 tokens
          example: A peaceful lake reflecting the beautiful sunset
          maxLength: 2000
        size:
          type: string
          description: >-
            Size of the generated image, currently only supports **pixel
            format**:
