...
> - Qwen (qwen-image-edit) model supports image editing, image-to-image and other modes
...
| --------------- | ------------- | --------------------- |
| Qwen Image Edit | Image Editing | 2.300 Credits / image |

## OpenAPI

````yaml en/api-manual/image-series/qwen/qwen-image-edit.json post /v1/images/generations
openapi: 3.1.0
info:
  title: qwen-image-edit Interface
  description: >-
...
paths:
  /v1/images/generations:
    post:
      tags:
        - Image Generation
      summary: qwen-image-edit Interface
      description: >-
        - Qwen (qwen-image-edit) model supports image editing, image-to-image
        and other modes
        ...
        promptly
      operationId: createQwenImageEditGeneration
      requestBody:
        required: true
        content:
          application/json:
            ...
            application/json:
              ...
              example:
                error:
                  ...
                  param: model
                  fallback_suggestion: qwen-image-edit
        "429":
